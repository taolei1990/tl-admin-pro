  ...
  >
    ...
    <div ref="scrollbarDom" class="scroll-container">
      <div class="tab select-none" ref="tabDom" :style="getTabStyle">
        ...
        >
          <div v-if="showModel === 'smart-on'" class="tag-smart-svg">
            <svg style="width: 100%; height: 100%">
              <defs>
                <symbol id="geometry-left" viewBox="0 0 214 30">
                  <path
                    d="M17 0h197v30H0v-2c4.5 0 9-3.5 9-8V8c0-4.5 3.5-8 8-8z"
                  />
                </symbol>
                <symbol id="geometry-right" viewBox="0 0 214 30">
